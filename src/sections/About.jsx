        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              ...
              JavaScript, React, Node.js, TypeScript, Tailwind CSS, and FastAPI—
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              I’m a Software Developer and Full Stack Web Developer — passionate
              about building fast, reliable, and scalable applications. I focus
              on writing clean code, improving performance, and delivering
              smooth user experiences.
            </p>
            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              I love transforming ideas into real-world products that solve
              problems and create meaningful value for users and businesses.
            </p>
          </motion.div>
        </div>
      </div>
